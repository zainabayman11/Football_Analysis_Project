...
#  get_object_tracks (improved version) ********
# Difference from the old one:
# - The ball is NOT tracked with ByteTrack
# - The ball is taken by detection only
# - Players + referees → tracking
# - Ball → detection + interpolation
#
# 📌 And this makes sense:
# - The ball moves very fast
# - Tracking for the ball often breaks
